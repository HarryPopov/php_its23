...
<html lang="et">
    ...
    <body>
        ...
        //head mõtted
        function headmotted(){
            $alus = array("Kati", "Mari", "Mai", "Kai", "Tiina", "Leena", "Liina", "Maaili");
    ...
    for ($i=10; $i >= 1; $i--) {
        ...
        <H1>MASSIIVID</H1>
          ...
          $nimed = array("Kati", "Mari", "Mai", "Kai", "Tiina", "Leena", "Liina", "Maaili");

      // print_r($nimed); (näitab mida saab kuvada)
      // var_dump (sama)
      // sort($nimed); - sorteerib nimed tähestiku järgi
      // rsort($nimed); - sorteerib nimed tagurpidi tähestiku järgi

        sort($nimed);
        //print_r($nimed);
        foreach ($nimed as $nimi) {
           // echo "$nimi <br>"; üks võimalus nimesi eraldada
           // echo $nimi ."<br>";
       ...
       // echo strlen($vins[0]); näitab esimese vin pikkust
